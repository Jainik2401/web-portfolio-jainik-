                    ...
                    <div class="fixed-column-wrap">
                        ...
                        <div class="fixed-column-wrap-content">
                                        ...
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="ms-item_fs fl-wrap">
                                                    <div class="bg par-elem"  data-bg="images/bg/200.jpg"  ></div>
                                                </div>
                                            </div>
                                            <!--ms_item end-->
                                            <!--ms_item-->
                                            <div class="swiper-slide ">
                                                <div class="ms-item_fs fl-wrap">
                                                    <div class="bg par-elem"  data-bg="images/bg/100.jpg"></div>
                                                </div>
                                            </div>
                                            <!--ms_item end-->
                                            <!--ms_item-->
                            ...
                            <div class="fixed-column-wrap_title first-tile_load">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas in pulvinar neque. Nulla finibus lobortis pulvinar.</p><br>
                            </div>
                            ...
                            <div class="fcwc-pagination fcwc-wrap"></div><br>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-5">
                                            <div class="dec-img   fl-wrap">
                                                <img src="images/500.jpeg" class="respimg" alt="">
                                    ...
                                    <div class="row">
                                        <div class="col-md-9">
                                            <div class="skillbar-box animaper">
                                                ...
                                                <!-- skill 1-->
                                                <div class="custom-skillbar-title"><span>PHP/CodeIgniter/WordPress</span></div>
                                                <div class="skill-bar-percent">95%</div>
                                                <div class="skillbar-bg" data-percent="95%">
                                                    <div class="custom-skillbar"></div>
                                                </div>
                                                <!-- skill 2-->
                                                <div class="custom-skillbar-title"><span>HTML/Css/Bootstrap</span></div>
                                                <div class="skill-bar-percent">85%</div>
                                                <div class="skillbar-bg" data-percent="85%">
                                                    <div class="custom-skillbar"></div>
                                                </div>
                                                <!-- skill 3-->
                                                <div class="custom-skillbar-title"><span>Photoshop/CorelDrraw</span></div>
                                                <div class="skill-bar-percent">75%</div>
                                                <div class="skillbar-bg" data-percent="75%">
                                                    <div class="custom-skillbar"></div>
                                                </div>
                                                <!-- skill 4-->
                                                <div class="custom-skillbar-title"><span>Python/Data Science with R</span></div>
                                                <div class="skill-bar-percent">60%</div>
                                                <div class="skillbar-bg" data-percent="60%">
                                                    <div class="custom-skillbar"></div>
                                                </div>
                                                <!-- skill 5-->
                                                <div class="custom-skillbar-title"><span>Javascript/Java</span></div>
