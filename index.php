                ...
                <div class="content full-height" data-pagetitle="Home slider">
                    <div class="fl-wrap full-height hero-conatiner">
                        <div class="hero-wrapper fl-wrap full-height hidden-item">
                                        ...
                                        <div class="swiper-wrapper" >
                                            ...
                                            <div class="swiper-slide">
                                                <div class="half-hero-wrap">
                                                    ...
                                                    <h1>I'm JAINIK<br><span> Web  developer</span> and designer<br></h1>
                                                    <h4>Experienced PHP Developer With Demostrated History Of Working  in PHP,CodeIgniter,WordPress,Java,HTML,Css,Javascript,Bootstrap,Python,Data Science with R .</h4>
                                                    <div class="clearfix"></div>
                                                    <a href="portfolio.php" class="btn ajax  fl-btn color-bg"><span>My portfolio</span></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="hero-slider-img hero-slider-wrap_halftwo hidden-item">
                                <div class="swiper-container">
                                    <div class="swiper-wrapper" >
                                        <!-- swiper-slide-->
                                        <div class="swiper-slide">
                                            <div class="bg"  data-bg="images/bg/100.jpg" data-swiper-parallax="20%"></div>
                                            <div class="overlay"></div>
                                        </div>
                                        <!-- swiper-slide end-->
                                        <!-- swiper-slide-->
                                        <div class="swiper-slide">
                                            <div class="bg"  data-bg="images/bg/200.jpg" data-swiper-parallax="20%"></div>
                                            <div class="overlay"></div>
                                        </div>
                                        <!-- swiper-slide end-->
                                        <!-- swiper-slide-->
                            ...
                            <!-- slider-controls end-->
                            <a href="about.php" class="ajax start-btn"><span> Start explore <i class="fal fa-long-arrow-right"></i></span></a>
